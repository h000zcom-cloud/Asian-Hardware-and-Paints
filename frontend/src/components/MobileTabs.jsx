...
export const MobileTabs = ({ tab, onChange, count, billLabel = 'Current Bill', tabsRef }) => (
  <><div className="mobile-tabs-anchor" ref={tabsRef} aria-hidden="true" />
  <div className="mobile-tabs" role="tablist" aria-label="Counter view" data-testid="mobile-pos-tabs">
